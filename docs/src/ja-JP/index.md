...
description: "M1hono が作成した Toolkit Box。"
cssVars:
  --vp-font-family-base: '"IBM Plex Sans", "Noto Sans JP", "Hiragino Sans", "Yu Gothic", sans-serif'
  ...
  --hero-text-font-size: "clamp(3rem, 5.6vw, 5.2rem)"
  --hero-text-weight: "760"
  --hero-text-letter-spacing: "-0.04em"
  --hero-text-line-height: "0.94"
  --hero-text-max-width: "9ch"
  --hero-tagline-font-size: "clamp(1rem, 1.56vw, 1.14rem)"
  --hero-tagline-weight: "500"
  --hero-tagline-line-height: "1.56"
  --hero-tagline-letter-spacing: "0"
  --hero-tagline-max-width: "42rem"
  --hero-tagline-padding-top: "18px"
  --hero-heading-gap: "0.16em"
...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: "アークナイツ"
      link: /ja-JP/Arknights/
    - theme: alt
      text: "JSON 編集"
      link: /ja-JP/Mc/JsonTranslator
    - theme: outline
      text: "Manaweave"
      link: /ja-JP/Mna/
features:
  - title: "サーヴァント立ち絵検索"
    details: "サーヴァント記録を検索し、差分を選択して立ち絵を書き出します。"
    icon: "FGO"
    link: /ja-JP/Fgo/CharaFinder
    linkText: "開く"
  - title: "FGO カード生成"
    details: "画像、文字、アイコン、数値ブロックからカード画像を生成します。"
    icon: "CARD"
    link: /ja-JP/Fgo/CardGenerator
    linkText: "開く"
  - title: "オペレーター立ち絵検索"
    details: "オペレーター記録を検索し、立ち絵差分を選択して出力します。"
    icon: "AK"
    link: /ja-JP/Arknights/CharaFinder
    linkText: "開く"
  - title: "ストーリー追跡"
    details: "オペレーター名から登場記録と関連リンクを確認します。"
    icon: "LOG"
    link: /ja-JP/Arknights/StoryTracker
    linkText: "開く"
  - title: "JSON 翻訳"
    details: "原文と対象言語の JSON を編集し、不足キーを確認して書き出します。"
    icon: "JSON"
    link: /ja-JP/Mc/JsonTranslator
    linkText: "開く"
  - title: "Manaweave ツール"
