...
cssVars:
  --vp-font-family-base: '"IBM Plex Sans", "Noto Sans SC", "Noto Sans JP", "Segoe UI Variable Text", sans-serif'
...
features:
  - title: "FGO"
    details: "Servant portrait lookup and card generation surfaces."
    icon: "FGO"
    link: /en-US/Fgo/
    linkText: "Open"
  - title: "Arknights"
    details: "Operator portrait lookup and story tracking tools."
    icon: "AK"
    link: /en-US/Arknights/
    linkText: "Open"
  - title: "Minecraft JSON"
    details: "Language JSON editing, review, and export workflow."
    icon: "JSON"
    link: /en-US/Mc/JsonTranslator
    linkText: "Open"
  - title: "Manaweave"
