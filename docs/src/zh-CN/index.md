...
description: "M1hono 编写的 Toolkit Box。"
cssVars:
  --vp-font-family-base: '"IBM Plex Sans", "Noto Sans SC", "PingFang SC", "Microsoft YaHei", sans-serif'
  ...
  --hero-text-font: '"IBM Plex Sans Condensed", "IBM Plex Sans", "Noto Sans SC", sans-serif'
...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: "明日方舟"
      link: /zh-CN/Arknights/
    - theme: alt
      text: "JSON 编辑"
      link: /zh-CN/Mc/JsonTranslator
    - theme: outline
      text: "Manaweave"
      link: /zh-CN/Mna/
features:
  - title: "从者立绘检索"
    details: "检索从者记录、切换素材变体、裁切并导出立绘。"
    icon: "FGO"
    link: /zh-CN/Fgo/CharaFinder
    linkText: "打开"
  - title: "FGO 卡牌生成器"
    details: "使用图片、文本、图标与数值块生成卡牌图。"
    icon: "CARD"
    link: /zh-CN/Fgo/CardGenerator
    linkText: "打开"
  - title: "干员立绘检索"
    details: "检索干员记录、选择立绘变体并导出结果。"
    icon: "AK"
    link: /zh-CN/Arknights/CharaFinder
    linkText: "打开"
  - title: "剧情追踪器"
    details: "按名称查找干员剧情出场记录并跳转链接。"
    icon: "LOG"
    link: /zh-CN/Arknights/StoryTracker
    linkText: "打开"
  - title: "JSON 翻译器"
    details: "导入源语言与目标语言 JSON，检查未翻译或孤立键并导出。"
    icon: "JSON"
    link: /zh-CN/Mc/JsonTranslator
    linkText: "打开"
  - title: "Manaweave 工具"
