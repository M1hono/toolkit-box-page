                            ...
                            >
                                ...
                                >
                                    <span v-if="link.icon" class="link-icon">
                                        <span :class="iconClass(link.icon)">
                                            {{
                                                iconClass(link.icon)
                                                    ? ""
                                                    : link.icon
                                    ...
                                    <span class="link-text">
                                        ...
                                        <span v-if="link.desc" class="desc">{{
                                            link.desc
                                        }}</span>
                                    </span>
                                </VPLink>
...
<style scoped>
    ...
    .VPNavLayoutColumns.is-open .menu-trigger {
    ...
    .VPNavLayoutColumns.is-open .icon {
    ...
    .VPNavLayoutColumns.is-open .mega-menu {
        opacity: 1;
        visibility: visible;
        pointer-events: auto;
    ...
    .mega-menu-content {
        ...
        min-width: 0;
        max-height: calc(100vh - var(--vp-nav-height) - 72px);
        overflow-y: hidden;
        overflow-x: hidden;
        overscroll-behavior: contain;
    }

    .mega-menu-content.has-preview {
        gap: 24px;
    }
    ...
    .preview-sheet {
        flex: 0 0 clamp(220px, 26vw, 310px);
