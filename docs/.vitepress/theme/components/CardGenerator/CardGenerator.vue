                ...
                <div class="main-layout">
                    <div class="left-panel">
                        <CardSettings
                            ...
                            @update:subname-color="
                                colorState.customSubnameColor.value = $event;
                                renderCardPreview();
                            "
                            @update:atk="
                                cardData.atk = $event;
                            ...
                            @update:use-numbers-for-stats="
                                statsState.useNumbersForStats.value = $event;
                                renderCardPreview();
                            "
                            @update:atk-text="
                            ...
                            @update:use-custom-icon="
                                customIconState.useCustomIcon.value = $event;
                                renderCardPreview();
                            "
                            @update:custom-icon-method="
                                customIconState.customIconMethod.value = $event;
                                onIconMethodChange();
                            "
                            @update:icon-url="
                                customIconState.customIconUrl.value = $event;
                                renderCardPreview();
                            "
                            @update:svg-text="
                                customIconState.customIconSvgText.value = $event
                            "
                            @update:svg-color="
                            ...
                            "
                            @update:icon-size="
                                customIconState.customIconSize.value = $event;
                                renderCardPreview();
                            "
                            @update:icon-x="
                    ...
                    <div class="right-panel">
                        <v-card class="panel-section">
                            <v-card-title class="text-h6">{{ t.preview }}</v-card-title>
                            <v-card-text>
