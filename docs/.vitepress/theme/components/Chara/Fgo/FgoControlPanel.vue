    ...
    <div class="control-panel">
        ...
        <div class="control-card">
            ...
            <div class="aspect-grid">
                <button
                    ...
                    :key="ratio"
                    :class="['aspect-btn', { active: currentAspectRatio === ratio }]"
        ...
        <div class="control-card">
            ...
            <div class="actions-grid">
                <button class="action-btn" @click="$emit('prev-diff')">‹ {{ t.prevDiff }}</button>
                <button class="action-btn" @click="$emit('next-diff')">{{ t.nextDiff }} ›</button>
                <button class="action-btn" @click="$emit('toggle-color')">{{ t.bgColor }}</button>
                <button class="action-btn primary" @click="$emit('save')">{{ t.save }}</button>
                <button class="action-btn" @click="$emit('batch')">{{ t.batch }}</button>
                <button class="action-btn" :disabled="isLocalImage" @click="$emit('detect-face')">
...
import type { SelectionRect, ColorRGBA } from '../../../../utils/chara/fgo/types';
...
function updatePreview() {
    ...
    context.clearRect(0, 0, previewCanvasRef.value.width, previewCanvasRef.value.height);
    
    const { r, g, b, a } = props.backgroundColor;
    context.fillStyle = `rgba(${r}, ${g}, ${b}, ${a})`;
    context.fillRect(0, 0, previewCanvasRef.value.width, previewCanvasRef.value.height);
...
watch(() => [props.selection, props.backgroundColor, props.currentCanvas], () => {
