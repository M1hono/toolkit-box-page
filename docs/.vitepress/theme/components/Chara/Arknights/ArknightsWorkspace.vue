...
<template>
    <div class="workspace-panel">
        <div class="workspace-header">
            <div class="header-main">
                <div class="header-left">
                    <h2 class="character-name">
                        {{ character?.displayName || t.noSelection }}
                    </h2>
                    <span v-if="character" class="variant-counter">
                        {{ currentVariantIndex + 1 }} /
                        {{ character.validVariants.length }}
                    </span>
                </div>
                ...
                <div v-if="character" class="header-actions">
                    ...
                    <button
                        ...
                        :disabled="
                            currentVariantIndex >=
                            character.validVariants.length - 1
                        "
            ...
            <div
                v-if="
                    character?.speakerNames && character.speakerNames.length > 1
                "
                class="names-box"
            >
                ...
                <div class="names-scroll">
                    <span
                        v-for="(name, idx) in character.speakerNames"
                        :key="idx"
                        class="name-badge"
                    >
                        {{ name }}
        ...
        <div v-if="character" class="workspace-toolbar">
            ...
            >
                <option
                    v-for="(v, i) in character.validVariants"
                    :key="v"
                    :value="v"
                >
                    {{ i + 1 }}. {{ v }}
...
<script setup lang="ts">
    ...
    watch(
        () => [props.selection, props.backgroundColor],
        () => {
