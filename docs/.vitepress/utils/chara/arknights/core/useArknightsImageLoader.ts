...
function getSpecialImageUrls(variant: string): { primary: string; fallback: string; secondary?: string } | null {
    const specialMappings: Record<string, any> = {
        'avg_npc_602_1#1$1': {
            primary: 'https://raw.githubusercontent.com/Aceship/Arknight-Images/main/avg/characters/avg_npc_602_1%241.png',
            fallback: 'https://raw.githubusercontent.com/akgcc/arkdata/main/assets/avg/characters/avg_npc_602_1%23%24%241.png',
            secondary: `https://${imageConfig.r2PublicUrl}/arknights/characters/avg_npc_602_1%231%241.png`
        },
        'avg_npc_598_1#2$1': {
            primary: 'https://raw.githubusercontent.com/Aceship/Arknight-Images/main/avg/characters/avg_npc_598_1%232%241.png',
            fallback: 'https://raw.githubusercontent.com/akgcc/arkdata/main/assets/avg/characters/avg_npc_598_1%232%24%241.png',
        ...
        return new Promise((resolve, reject) => {
            ...
            img.onerror = () => {
                ...
                if (match) {
                    ...
                    let nextUrl = null;
                    if (url === urls.primary && urls.fallback) nextUrl = urls.fallback;
                    else if (url === urls.fallback && urls.secondary) nextUrl = urls.secondary;
                    
                    if (nextUrl && nextUrl !== url) {
                        const fallbackImg = new Image();
                        fallbackImg.crossOrigin = "anonymous";
                        fallbackImg.onload = () => resolve(fallbackImg);
                        fallbackImg.onerror = () => reject(new Error(`All URLs failed`));
